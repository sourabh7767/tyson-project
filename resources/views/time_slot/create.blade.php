                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('users.index')}}">Time Slot</a>
                                    </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input class="form-control" type="date" name="date" placeholder="Slot Date" />
                                                    @if ($errors->has('date'))
                                                        <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input id="no_of_slots" type="text" class="form-control {{ $errors->has('no_of_slots') ? ' is-invalid' : '' }}" name="no_of_slots" placeholder="No of slots">
