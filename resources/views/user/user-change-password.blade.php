...
@section('title') Change User Password @endsection
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Change User Password
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5><b>Change User Password</b></h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{route('user.changeUserPassword.submit',$id)}}">
                    @csrf
